/**
 * Created by legendtao1985 on 11/19/16.
 */
...
Line.prototype.draw = function (context) {
    ...
    context.lineTo(this.y2, this.y2);
    context.closePath();
    context.stroke();
    context.restore();
}
...
Line.prototype.getBounds = function(){
    if(this.rotation == 0){
        ...
        var sin = Math.sin(this.rotation),
            ...
            x1r = cos * this.x1 + sin * this.x1,
            x2r = cos * this.x2 + sin * this.x2,
            y1r = cos * this.y1 + sin * this.y1,
            y2r = cos * this.y2 + sin * this.y2;
